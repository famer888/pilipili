    ...
    if (kIsWeb) {
      ...
      if (AppGlobal.m3u8_encrypt == '1') {
        createServer(url).then((proxyConfig) {
          String proxyurl = url.replaceAll(proxyConfig['origin'], proxyConfig['localproxy']);
                    ...
                    child: Center(
                      child: _controller.value.isInitialized
                          ? Stack(
                              children: [
                                Center(
                                  child: VideoContainer(videoController: _controller),
                                ),
                                Positioned(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                          child: SliderTheme(
                                              ...
                                              child: Slider(
                                                  value: videoValue >= videoMaxTime ? videoMaxTime : videoValue,
                                                  max: videoMaxTime,
                                                  min: 0,
                                                  onChangeStart: (e) {
                                                    usecheck = true;
                                                    changeStartIsPlay = _controller.value.isPlaying;
                                                    _controller.pause();
                                                  },
                                                  onChangeEnd: (e) {
                        ...
                        _controller == null || (_controller != null && !_controller.value.isInitialized)
                            ...
                            : Positioned(
                                ...
                                child: AnimatedOpacity(
                                  opacity: showControl || !_controller.value.isPlaying ? 1 : 0,
