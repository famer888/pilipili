                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.only(
                                  topRight: Radius.circular(
                                      ScreenUtil().setWidth(fixedNav == null || fixedNav.length == 0 ? 24 : 30)),
                              ...
                              child: Container(
                                ...
                                padding: EdgeInsets.symmetric(
                                    vertical:
                                        ScreenUtil().setWidth(fixedNav == null || fixedNav.length == 0 ? 12 : 16)),
                                child: fixedNav == null || fixedNav['value'].length == 0
                                    ? Container()
                                    : Wrap(
                                        alignment: WrapAlignment.center,
                                        spacing: ScreenUtil().setWidth(5),
                                        children: fixedNav['value'].asMap().keys.map<Widget>((e) {
                                          return HomeNavBtn(
